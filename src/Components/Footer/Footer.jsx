    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center sm:text-left">
        ...
        <div className="space-y-1">
          ...
          <p>
            <span className="font-medium">Phone:</span> +88 01719761337
          </p>
        ...
        <div className="space-y-1">
          ...
          <ul className="space-y-1">
            <li>
              <a className="link" href="https://linkedin.com/in/rabiul3000" target="_blank">Linkedin</a>
            </li>
            <li>
              <a className="link" href="https://www.facebook.com/md.rabiul.366471" target="_black">Facebook</a>
            </li>
            <li>
